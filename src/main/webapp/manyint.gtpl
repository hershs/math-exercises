...
<blockquote>
    <form name="manyIntForm" action="manyint.groovy" method="post">
        ...
        Number of integers: <input name="m" id="m" type="number" value="3" min="2" max="5"/><br/><br/>
        ...
        <br/><br/>
        Maximum integer value: <input id="maxwhole" name="maxwhole" type="number" value="99" min="2"
                                      max="9999"/><br/><br/>
        Minimum integer value: <input id="minwhole" name="minwhole" type="number" value="10" min="2"
                                      max="99"/><br/><br/>
